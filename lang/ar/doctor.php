...
return [
    ...
    'no_assigned_days' => 'لا يوجد أي يوم مُعيَّن لك هذا الأسبوع. تواصل مع الإدارة لمراجعة توزيع الأيام.',

    'errors' => [
        'not_your_day' => 'هذا الحجز يقع بيوم مُعيَّن لدكتور آخر.',
    ],
    ...
    'bookings_table' => [
        ...
        'not_available_yet_hint' => 'يمكن إرفاق التقرير بعد حلول موعد الحجز',
    ...
    'report_modal' => [
        ...
        'history_heading' => 'الزيارات السابقة',
        'history_condition' => 'الحالة',
        'history_diagnosis' => 'التشخيص',
        'history_medications' => 'الأدوية',
        'condition' => 'الحالة',
        'examination' => 'الفحص',
        ...
        'not_started_yet' => 'لا يمكن إرفاق تقرير قبل حلول موعد الحجز.',
