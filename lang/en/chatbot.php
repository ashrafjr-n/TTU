...
return [
    ...
    'topics' => [
        ...
        'booking' => [
            ...
            'detailed' => 'The booking page only ever shows the current booking window: the clinic working days (Sunday to Thursday) from today until the end of the current week, up to three days at a time — so the window shrinks near the end of the week (Wednesday shows two days, Thursday just one). Booking closes entirely from Thursday at 4:00 PM through the end of Friday; Saturday is a special case where booking reopens early for the next week\'s first two working days (Sunday and Monday) instead of waiting until Sunday. Clinic hours run from 8:00 AM to 4:00 PM, split into 5-minute slots — students book the slots in the earlier part of each hour, and the last slots of every hour are reserved for staff. You can hold only one active booking at a time, so if you already have one you will be asked to cancel it before booking again, and each person is limited to 4 confirmed bookings per semester. Once confirmed, the appointment appears on your dashboard and you get a reminder notification before it starts.',
